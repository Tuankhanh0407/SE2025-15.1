...
2. Open Mailpit at `https://hubs.local:8025`, find the email with the magic link, and open it in the browser to complete verification. This will create the first entry in our accounts table.
...
5. Attempt to log in with your email once again and you should now have access to the admin panel at `https://hubs.local:4000/admin`.
