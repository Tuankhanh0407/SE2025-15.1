...
import { SOUND_CHAT_MESSAGE, SOUND_QUACK, SOUND_SPECIAL_QUACK, SOUND_CAMERA_TOOL_TOOK_SNAPSHOT } from "./systems/sound-effects-system";
...
export default class MessageDispatch extends EventTarget {
  ...
  addToPresenceLog(entry) {
    ...
    if (entry.type === "hand_raised" && this.scene.is("loaded")) {
      this.scene.systems["hubs-systems"].soundEffectsSystem.playSoundOneShot(SOUND_CAMERA_TOOL_TOOK_SNAPSHOT);
    }
